...
export default function DashboardPage({
  ...
  const systemInfoItems = useMemo(
    () => [
      ...
      { label: "项目数量", value: stats.project_total },
      { label: "环境数量", value: stats.environment_total },
      { label: "邮箱池数量", value: stats.mailbox_pool_total },
    ...
    [
      ...
      stats.deleted_email_total,
      stats.email_total,
      stats.environment_total,
      stats.error_total,
      stats.mailbox_pool_total,
      stats.matched_email_total,
      stats.project_total,
    ],
  );
